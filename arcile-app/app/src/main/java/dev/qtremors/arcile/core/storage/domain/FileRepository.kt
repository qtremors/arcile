 ...
 *
 * The single concrete implementation is [dev.qtremors.arcile.core.storage.data.LocalFileRepository], which
...
interface FileMutationRepository {
     ...
     * [dev.qtremors.arcile.core.storage.data.LocalFileRepository.deleteFile] is an example of soft-delete:
