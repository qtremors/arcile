...
fun mergeStorageClassifications(
    ...
    return volumes.map { vol ->
        ...
        if (classification != null) {
            ...
            vol.copy(
                kind = if (vol.isPrimary) dev.qtremors.arcile.core.storage.domain.StorageKind.INTERNAL else dev.qtremors.arcile.core.storage.domain.StorageKind.EXTERNAL_UNCLASSIFIED,
