...
fun buildScheme(primary: Color, isDark: Boolean): ColorScheme {
    return if (isDark) {
        ...
        lightColorScheme(
            ...
            primaryContainer = primary.copy(alpha = 0.20f).compositeOver(Color.White),
            onPrimaryContainer = primary, 
            secondary = primary.copy(alpha = 0.70f).compositeOver(Color.White),
            onSecondary = Color.White,
            secondaryContainer = primary.copy(alpha = 0.16f).compositeOver(Color.White),
