...
internal data class BrowserUiActions(
    ...
    val onRefresh: () -> Unit,
    val onSearchFiltersChange: (dev.qtremors.arcile.domain.SearchFilters) -> Unit,
    ...
    val onExtractSelectedArchive: (String?) -> Unit,
    val onExtractSelectedArchiveToFolder: (String?) -> Unit,
