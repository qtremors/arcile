...
internal val AUDIO_FAVORITE_FILES_KEY = stringPreferencesKey("audio_favorites")
internal val AUDIO_PINNED_FOLDERS_KEY = stringPreferencesKey("audio_pinned_folders")
internal val AUDIO_FOLDER_COVERS_KEY = stringPreferencesKey("audio_folder_covers")
internal val CATEGORY_GROUPINGS_KEY = stringPreferencesKey("category_groupings")
internal val CATEGORY_DEFAULT_PAGES_KEY = stringPreferencesKey("category_default_pages")
internal val CATEGORY_SHOW_FILE_DETAILS_KEY = stringPreferencesKey("category_show_file_details")
internal val CATEGORY_ASPECT_RATIOS_KEY = stringPreferencesKey("category_aspect_ratios")
internal val CATEGORY_SECTIONED_KEY = stringPreferencesKey("category_sectioned")
