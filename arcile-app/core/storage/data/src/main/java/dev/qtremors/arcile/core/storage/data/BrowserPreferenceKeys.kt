...
internal val AUDIO_SORT_OPTION_KEY = stringPreferencesKey("audio_sort_option")
internal val AUDIO_VIEW_MODE_KEY = stringPreferencesKey("audio_view_mode")
internal val AUDIO_LIST_ZOOM_KEY = floatPreferencesKey("audio_list_zoom")
internal val AUDIO_GRID_MIN_CELL_SIZE_KEY = floatPreferencesKey("audio_grid_min_cell_size")
internal val AUDIO_FOLDER_SORT_OPTION_KEY = stringPreferencesKey("audio_folder_sort_option")
internal val AUDIO_FOLDER_VIEW_MODE_KEY = stringPreferencesKey("audio_folder_view_mode")
internal val AUDIO_FOLDER_LIST_ZOOM_KEY = floatPreferencesKey("audio_folder_list_zoom")
internal val AUDIO_FOLDER_GRID_MIN_CELL_SIZE_KEY =
    floatPreferencesKey("audio_folder_grid_min_cell_size")
internal val AUDIO_GROUPING_KEY = stringPreferencesKey("audio_grouping")
internal val AUDIO_DEFAULT_TAB_KEY = stringPreferencesKey("audio_default_tab")
internal val AUDIO_SHOW_FILE_DETAILS_KEY = booleanPreferencesKey("audio_show_file_details")
...
internal val FILE_OPEN_BEHAVIORS_KEY = stringPreferencesKey("file_open_behaviors")
