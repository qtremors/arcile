...
fun NavGraphBuilder.registerDocumentLibraryRoute(
    onNavigateBack: () -> Unit,
    ...
    composable<AppRoutes.DocumentLibrary> {
        val viewModel = hiltViewModel<DocumentLibraryViewModel>()
        ...
        DocumentLibraryScreen(
            ...
            onOpenFile = { onOpenFile(it, state.files) },
